...
const contracts = [
  {
    ...
    repository: 'https://github.com/kda-community/sample-contract-1',
    auditState: 'Audited',
    version: '1.0.0',
  },
  {
    ...
    repository: 'https://github.com/kda-community/sample-contract-2',
  ...
  },
  {
    ...
    repository: 'https://github.com/kda-community/sample-contract-3',
